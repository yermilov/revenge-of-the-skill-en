...
import { WhenHowCreateSkillSlide } from './WhenHowCreateSkillSlide';
import { SkillFlywheelSlide } from './SkillFlywheelSlide';
import { AgentsSlide } from './AgentsSlide';
import { SkillUsageTrackingSlide } from './SkillUsageTrackingSlide';
import { FinalSlide } from './FinalSlide';

export const slides = [TitleSlide, StarWarsCrawlSlide1, BioSlide, StarWarsCrawlSlide2, JuniorEngineerSlide, StarWarsCrawlSlide3, VibeFlowStepsSlide, StarWarsCrawlSlide4, BreakOutOfCodingSlide, ClaudeCodeSlide, StarWarsCrawlSlide6, WhatIsSkillSlide, StarWarsCrawlSlide7, MarketplacesSlide, StarWarsCrawlSlide8, SkillAnatomySlide, SkillStructureSlide, SkillFrontmatterMapSlide, SkillPatternsSlide, SkillsPyramidSlide, WhenHowCreateSkillSlide, SkillBecauseSlide, SkillAntiPatternsSlide, SkillOpenFormatSlide, MetaSkillSlide, SkillsActivatorSlide, HookAnatomySlide, HookContractSlide, HookGotchasSlide, HookDevSkillSlide, SkillMarketplaceSlide, PluginAnatomySlide, PluginManifestSlide, MarketplaceManifestSlide, PluginDiscoverabilitySlide, PluginShippingSlide, PluginDevSkillSlide, SkillUsageTrackingSlide, HowItWorksTogetherSlide, SoftwareFactorySlide, SkillFlywheelSlide, AgentsSlide, FinalSlide];
